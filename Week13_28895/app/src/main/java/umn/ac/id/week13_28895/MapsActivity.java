package umn.ac.id.week13_28895;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentLocation = new LatLng(-6.2574591, 106.6138484);
    ...
    public void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK && reqCode == REQUEST_TAMBAH){
            ...
            double[] dTtitiks = data.getDoubleArrayExtra("titiks");
            List<LatLng> mTitiks = new ArrayList<LatLng>();
            for(int i = 0; i < dTtitiks.length/2; i++){
                mTitiks.add(new LatLng(dTtitiks[2*i], dTtitiks[2*i+1]));
            }
